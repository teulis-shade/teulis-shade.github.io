...
var flowerSprite = new Image(5, 5);
flowerSprite.src = "flower.png";
flowerSprite.name = "Flower";
// flowerSprite points = 50;

var footballSprite = new Image(5, 5);
footballSprite.src = "GTVertical_RGB.png";
footballSprite.name = "Football";
// footballSprite points = 50;

var tSprite = new Image(5, 5);
tSprite.src = "GTVertical_RGB.png";
tSprite.name = "T"
// tSprite.points = 50;

var ratcapSprite = new Image(5, 5);
ratcapSprite.src = "GTVertical_RGB.png";
ratcapSprite.name = "Ratcap"
// ratcapSprite.points = 50;

var ugaSprite = new Image(5, 5);
ugaSprite.src = "GTVertical_RGB.png";
ugaSprite.name = "UGA";
// ugaSprite.points = -10000;

var honeySprite = new Image(5, 5);
honeySprite.src = "GTVertical_RGB.png";
honeySprite.name = "Honey";
// honeySprite.points = -80;

var wreckSprite = new Image(5, 5);
wreckSprite.src = "GTVertical_RGB.png";
wreckSprite.name = "Wreck";
// wreckSprite.points = 500;

var georgeSprite = new Image(5, 5);
georgeSprite.src = "GTVertical_RGB.png";
...
function draw() {
    ...
    fallingObjects.forEach(element => 
        {
            ...
            //Just for now, so that we don't have nothingness falling
            if (element.sprite.src == "file:///C:/Users/zigti/Desktop/Wingin-It/WinginIt.html") {
    ...
    //High Score Testing
    ctx.fillText("High Score: " + GetHighScore(), 10, 70);
...
function GetHighScore() {
    if (document.cookie.split("; ").find((row) => row.startsWith("HighScore="))?.split('=')[1] == undefined) {
        console.log("High Score doesn't exist");
        return "0";
    }
